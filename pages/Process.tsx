...
const AgencyProcess: React.FC = () => {
    return <div className="bg-white text-black text-center justify-center items-center mx-auto flex flex-col">
        <div className="flex flex-col pb-12">
            ...
            <div className="flex flex-col text-center justify-center mx-auto mb-12 px-5 items-center">
                <div className="flex flex-col text-xs lg:text-xl mb-12 font-medium text-center mx-auto">
                    <h1 className="text-xl md:text-4xl mb-4 md:text-left font-bold text-slate-500">Mobile Games/Desktop Games</h1>
                    <ul className="md:text-left xl:text-3xl">
                ...
                <div className="flex flex-col text-xs lg:text-xl mb-12 font-medium text-center mx-auto">
                    <h1 className="text-xl xl:text-4xl text-slate-500 mb-4 font-bold md:text-right">Saas Applications/E-Commerce</h1>

                    <ul className="md:text-right xl:text-3xl">
